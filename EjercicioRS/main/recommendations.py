...
# Load data from CSV files into Django models
def load_data_from_csv(peliculas_csv, puntuaciones_csv):
    Pelicula.objects.all().delete()
    Puntuacion.objects.all().delete()

    with open(peliculas_csv, newline='', encoding='utf-8') as csvfile:
    ...
    with open(puntuaciones_csv, newline='', encoding='utf-8') as csvfile:
        reader = csv.DictReader(csvfile)
        for row in reader:
            Puntuacion.objects.create(
                idUsuario=row['idUsuario'],
                idPelicula_id=row['idPelicula'],
